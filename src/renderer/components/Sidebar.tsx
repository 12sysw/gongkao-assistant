...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { path: '/review', label: '今日复习', icon: Focus },
      { path: '/mock-exam', label: '套题模考', icon: ClipboardList },
    ],
  },
  {
    title: '核心工具',
    items: [
      { path: '/question-bank', label: '真题题库', icon: Library },
      { path: '/essay-review', label: '申论训练', icon: PenTool },
      { path: '/rag-chat', label: 'AI 名师', icon: Sparkles },
