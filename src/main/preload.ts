...
const api = {
  ...
  rag: {
    docAdd: (doc: any) => ipcRenderer.invoke(IPC.RAG_DOC_ADD, doc),
    docGetAll: () => ipcRenderer.invoke(IPC.RAG_DOC_GET_ALL),
    docGetById: (id: number) => ipcRenderer.invoke(IPC.RAG_DOC_GET_BY_ID, id),
    docUpdate: (doc: any) => ipcRenderer.invoke(IPC.RAG_DOC_UPDATE, doc),
    ...
    sessionAddMessage: (msg: any) => ipcRenderer.invoke(IPC.RAG_SESSION_ADD_MESSAGE, msg),
