...
1. 从 [GitHub Releases](https://github.com/12sysw/gongkao-assistant/releases) 下载最新安装包（NSIS 安装版 `.exe`）
2. 双击运行安装程序，选择安装目录
3. 启动应用，进入设置页面配置 AI 接口
4. 导入题库即可开始刷题

**自动更新**：安装版内置自动更新，启动时自动检查新版本，也可每 4 小时自动检查。
